    ...
    <div class="container max-w-5xl mx-auto px-4 md:px-12 pb-3 mt-3 break-words">
        ...
        <div id="home" class="big-bg">
            ...
            <div class="home-content wrapper">
                <h2 class="page-title text-4xl text-center my-12 font-bold">牛タンの数だけ笑顔がある<h2>
            </div><!-- /.home-content -->
        </div><!-- /#home -->
        ...
        <form method="GET" action="{{ route('posts.index') }}">   
            ...
            <div class="relative">
                ...
                <input name="search" type="search" id="default-search" value="{{ $search }}" class="block w-full p-4 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="お店の名前、場所" required>
            ...
            @foreach ($posts as $post)
                <article class="w-full px-4 md:w-1/2 text-xl text-gray-800 leading-normal">
                    <a href="{{ route('posts.show', $post) }}">
                        <h2
                            class="font-bold font-sans break-normal text-gray-900 pt-12 pb-1 text-3xl md:text-2xl break-words">
                            {{ $post->title }}</h2>
